...
The data type of phoneId extracted using useParams in React Router is a string. Even though the URL contains a numeric value (5), useParams returns all path parameters as strings.
# Feedback

3/3 points
Yes, useParams returns parameters as strings!
